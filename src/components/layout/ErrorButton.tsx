  ...
  render(): React.ReactNode {
    ...
    return (
      <button
        ...
        className="inline-flex items-center animate-pulse bg-amber-300 text-black border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 hover:cursor-pointer rounded text-base"
      >
        Throw Error
      </button>
    );
